...
class ApiHelperImpl(private val apiService: ApiService) : ApiHelper {
    ...
    override suspend fun getSongQuestionList(reportType: String,type:String): List<QuizList> = apiService.getSongQuestionList(reportType,type)

    override suspend fun getLeaderBoardList(reportType: String,msisdn:String): LeaderBoardOutput = apiService.getLeaderBoardList(reportType,msisdn)
