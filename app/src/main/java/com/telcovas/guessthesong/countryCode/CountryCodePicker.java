    ...
    private void applyCustomProperty(AttributeSet attrs) {
        ...
        try {
            ...
            if (isInEditMode()) {
                ...
                contentColor = a.getColor(R.styleable.CountryCodePicker_ccp_contentColor, context.getResources().getColor(R.color.black));
            }
            ...
            if (isInEditMode()) {
                ...
                borderFlagColor = a.getColor(R.styleable.CountryCodePicker_ccp_flagBorderColor, context.getResources().getColor(R.color.purple_200));
            }
            ...
            if (textSize > 0) {
                ...
                setTypeFace(getResources().getFont(R.font.kavoon));
            }
